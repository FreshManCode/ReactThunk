...
class ComA extends React.Component {
    ...
    componentDidMount() {
        if (getQueryVariable('token')) {
            ...
            this.props.requestFaceIDResult(params,res=>{
    ...
    callOutJS = ()=>{
        ...
        this.props.requestFaceIDToken(success=>{
            if (success.code == '1000') {
                ...
                window.startVerify(token,'https://h5.hisign.com.cn:42116/iv-live/live')
            } else {
      ...
      const number = this.state.selsectValue 
        return <div className='ComA'>
            <div className="buttonContainer">
                ...
                <button onClick={()=>{this.props.incrementAsyc(number)}}>异步加法</button>
            </div>
            <select ref={val => this.selsectVal = val} onChange={this.selectOnchange}>
